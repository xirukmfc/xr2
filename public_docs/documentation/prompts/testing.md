...
2. Press `⌘T` (Mac) or `Ctrl+T` (Windows)
3. Right-click → **Test Prompt**
...
{% hint style="info" %}
xR2 doesn't store your LLM API keys on our servers. They're encrypted and stored in your browser.
{% endhint %}
...
Recent tests are saved automatically:

1. Click **History** tab in the modal
2. View past test configurations
3. Click to re-run with same settings
4. Compare responses across tests
...
Save frequently-used test setups:

1. Configure your test
2. Click **Save Configuration**
3. Name it (e.g., "Standard Support Test")
4. Access from **Saved Tests** dropdown

## Bulk Testing (Coming Soon)

Test multiple scenarios automatically:
- Upload CSV with test cases
