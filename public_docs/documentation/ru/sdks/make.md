...
### Быстрая установка (по ссылке)

Официальное приложение xR2 сейчас проходит ревью для публикации в маркетплейсе Make.com. Но вы уже можете установить его по invite-ссылке:

**[Установить приложение xR2 для Make.com](https://eu2.make.com/app/invite/7314860fdac4e42901280ee576aed8c8)**

Это то же самое официальное приложение — invite-ссылка даёт полный доступ, пока мы ждём одобрения в маркетплейсе.

### Ручная настройка (Custom App)

Также можно настроить интеграцию вручную:
