...
1. Go to the test results
2. Click **Deploy Winner**
3. Confirm deployment
4. Test ends automatically
5. Winner becomes production version
...
**Hypothesis**: Friendlier tone increases signups
**Result**: Confirmed

### Data
- Version A (formal): 12.0% conversion
- Version B (friendly): 14.0% conversion
- Improvement: +16.7%
- Confidence: 94%
- Sample size: 5,000

### Learnings
- Users respond better to casual language
- Effect stronger for new users
- No negative impact on support tickets

### Next Steps
- Test even more casual tone
- Apply friendly tone to checkout prompt
```
...
- Can we fix B's downsides?
- What's the net business impact?
...
Options:
- Deploy B (prioritize acquisition)
- Deploy A (prioritize retention)
- Use different prompts per segment
...
1. Click **Export** on test results
2. Choose format:
   - CSV (raw data)
   - PDF (report)
3. Download
