...
{% hint style="info" %}
Create versions before starting the test. You can't modify versions while a test is running.
{% endhint %}
...
| **Success Event** | The conversion event to measure |
...
Choose the event that defines "success":

**Common choices:**
- `signup_completed` — For acquisition
- `purchase_completed` — For revenue
- `positive_feedback` — For satisfaction
- `task_completed` — For engagement
