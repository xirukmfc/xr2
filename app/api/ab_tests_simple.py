        ...
        return [
            {
                ...
                "version_a_id": str(test.version_a_id) if test.version_a_id else None,
                "version_a_name": f"v{test.version_a.version_number}" if test.version_a else "Unknown",
                "version_a_number": test.version_a.version_number if test.version_a else None,
                "version_b_id": str(test.version_b_id) if test.version_b_id else None,
                "version_b_name": f"v{test.version_b.version_number}" if test.version_b else "Unknown",
                "version_b_number": test.version_b.version_number if test.version_b else None,
