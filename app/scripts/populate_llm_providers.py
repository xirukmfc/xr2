    ...
    return [
        {
            ...
            "models": [
                ...
                {"id": "o3-pro", "name": "o3-pro", "description": "o3-pro reasoning model"},
                {"id": "o3", "name": "o3", "description": "o3 reasoning model"},
                {"id": "o4-mini", "name": "o4-mini", "description": "o4-mini compact reasoning model"},
                ...
                {"id": "o1", "name": "o1", "description": "o1 reasoning model"},
            ]
        },
        {
            "name": "anthropic",
