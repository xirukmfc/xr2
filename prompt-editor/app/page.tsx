        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="https://xr2.gitbook.io/docs" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 text-sm font-medium">{t('landing.nav.docs')}</a>
              <button
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100">
            <div className="px-6 py-4 space-y-4">
              ...
              <a href="https://xr2.gitbook.io/docs" target="_blank" rel="noopener noreferrer" className="block text-gray-600 hover:text-gray-900 py-2 font-medium">{t('landing.nav.docs')}</a>
              <div className="pt-4">
