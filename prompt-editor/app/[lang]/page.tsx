...
export default function LandingPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <>
      ...
      <head>
        <link rel="alternate" hrefLang="en" href="https://xr2.uk/en" />
        <link rel="alternate" hrefLang="ru" href="https://xr2.uk/ru" />
        <link rel="alternate" hrefLang="x-default" href="https://xr2.uk/en" />
        <link rel="canonical" href={`https://xr2.uk/${currentLang}`} />
      </head>
