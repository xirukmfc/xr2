...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    try {
      // Forward request to FastAPI precise endpoint
      const response = await fetch(`${FASTAPI_BASE_URL}/internal/llm/tokenize/precise`, {
        method: 'POST',
        headers: {
    ...
    console.error('Precise tokenization error:', error);
