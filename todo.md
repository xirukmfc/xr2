...
3. Сделать SDK для Make. Откуда Category взялись? Тут какой-то фиксированный справочник блин
4. Сделать SDK для Hubspot 
5. Сделать SDK для Zapier 
6. Сделать SDK для Bubble.io 
7. Сделать SDK для Airtable эт
8. Сделать SDK для Salesforce 
9. Сделать SDK для Slack Workflows 

1. Русская версия 
2. Автотесты
3. Test it all (manual and auto)

1. каждый SDK. Получить промта, Записать событие.
2. Инструкция по использованию 
3. Нужно где описать какие SDK есть

1. Дизайн сайта и маркетинговая подача А

1. Выверить используемые модели в test AI 
