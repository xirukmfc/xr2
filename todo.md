1. Самому пройти весь процесс 
2. Сделать SDK для PIP 
3. Сделать SDK для n8n 
4. Сделать SDK для Make 
5. Сделать SDK для Hудubspot 
6. Сделать SDK для Zspier 
7. Сделать SDK для Bubble.io (Priority: High)
8. Сделать SDK для Airtable (Priority: High)
9. Сделать SDK для Salesforce (Priority: Medium)
10. Сделать SDK для Slack Workflows (Priority: Medium)
11. Прогнать весь процесс вручную 
12. Дизайн сайта и маркетинговая подача
12. Мониторинг системы 
13. Для прода оставить только авторизация через Gmail/Demo пользователь
14. Сделать/обновить readme и навести порядок, отключить лишние логи типо 
