1. NB! I have to create an instruction for Analytic's matter. Don't forget to describe how to link A/B test and metrics. 
2. Сделать SDK для PIP 
3. Сделать SDK для n8n 
4. Сделать SDK для Make 
5. Сделать SDK для Hудubspot 
6. Сделать SDK для Zspier 
7. Сделать SDK для Bubble.io
8. Сделать SDK для Airtable
9. Сделать SDK для Salesforce
10. Сделать SDK для Slack Workflows
11. Test it all (manual and auto)
12. Дизайн сайта и маркетинговая подача
13. Нужно описать кейсы использования A/B 
14. Logo and favicon 
15. Русская версия 
...
19. Сделать/обновить readme и навести порядок, отключить лишние логи типо 
